...
"void main()\n"
"{\n"
"gl_Position = position * view * model * vec4(pos, 1.0);\n"
"}\n";
...
int main() {
	...
	while (!glfwWindowShouldClose(pointer_to_window))
	{
		...
		unsigned int modelLoc2 = glGetUniformLocation(light_program, "model");
		unsigned int viewLoc2 = glGetUniformLocation(light_program, "view");
		unsigned int projectionLoc2 = glGetUniformLocation(light_program, "projection");
